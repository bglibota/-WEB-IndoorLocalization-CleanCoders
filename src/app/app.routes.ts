...
import { TrackedAssetDetailComponent } from './Pages/reports/HeatmapReport/TrackedAssetDetails/trackedassetdetail.component';
...
export const routes: Routes = [
    ...
    { path: 'trackedassetdetails/:startDate/:endDate/:startTime/:endTime', component: TrackedAssetDetailComponent  },
